...
init("user_lYQGdZY6px0tBSy6YReNS");
...
class contact extends Component {
  ...
  handleSubmit(e) {
    ...
    emailjs.send("service_oqo35w9", "template_VjpSlN4a", templateParams);
    this.resetForm();
  }
            ...
            <section className="contact">
              ...
              <div className="contact__social">
                <h3 className="phone-number">
                  Location : Sandal Place Northeast, Canton, OH
                  <br />
                  Phone : +1 (330) 299 9790‬
                </h3>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a
